    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            ...
            if (results_dic[key][3] == 1 and results_dic[key][4] == 0):
                print("Pet Image Label is a Dog - ",results_dic[key][0],"\nClassified as NOT-A-DOG - ",results_dic[key][1])
            if (results_dic[key][3] == 0 and results_dic[key][4] == 1):
                print("Pet Image Label is NOT-a-Dog - ",results_dic[key][0],"\nClassified as a dog - ",results_dic[key][1])
